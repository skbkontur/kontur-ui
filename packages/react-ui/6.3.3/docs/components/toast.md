...
> Package: `@skbkontur/react-ui` · Version: `6.3.3` · [Storybook](https://tech.skbkontur.ru/kontur-ui/?path=/docs/react-ui_overlay-toast--docs)
...
- [SingleToast](https://tech.skbkontur.ru/kontur-ui/docs/components/singletoast.md) — тот же сценарий уведомлений без монтирования своего `Toast` и вызова через `ref`.
