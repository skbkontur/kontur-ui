...
> Package: `@skbkontur/react-ui` · Version: `6.4.0` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/?path=/docs/react-ui_input-data-timepicker--docs)
...
[Input](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/input.md) — если пользователю достаточно свободного текстового ввода без форматных ограничений.

[DatePicker](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/datepicker.md) — если вместе со вводом нужно выбирать дату в календаре.

## Примеры

## Кастомизация

Для кастомизации компонента через theme доступны переменные с префиксом `timePicker*`, которые можно найти в [ThemePlayground](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/?path=/docs/react-ui_information-themeplayground--docs).
