...
> Package: `@skbkontur/react-ui` · Version: `6.4.0` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/?path=/docs/react-ui_date-components-dateinput--docs)

Поле ввода для выбора даты с клавиатуры. Используется в [поле с датой](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/datepicker.md).
...
Если вам нужно поле ввода даты не только с вводом с клавиатуры, но и с выбором в блоке календаря - используйте - [DatePicker](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/datepicker.md).
...
Примеры обработок ошибок для поля смотрите на странице компонента [Поле с датой](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/datepicker.md) в блоке «Валидация».
