...
> Package: `@skbkontur/react-ui` · Version: `6.4.0` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/?path=/docs/react-ui_input-data-currencyinput--docs)
...
Если вам нужно отобразить в интерфейсе просто денежную сумму, не включая её в поле ввода, используйте [CurrencyLabel](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/currencylabel.md).
