...
> Package: `@skbkontur/react-ui` · Version: `6.4.0` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/?path=/docs/react-ui_display-data-loader--docs)
...
Когда происходит загрузка, поверх этого компонента или контента будет отображаться [Спиннер](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/spinner.md).
...
- [Глобальный лоадер](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/globalloader.md) — подходит для индикации длительных операций обмена данными с сервером, таких как загрузка данных, сохранение формы, отправка запросов и др.
- [Спиннер](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/spinner.md) — подходит для инлайн-встраивания или более гибкой настройки внешнего вида (цвет, толщина, затемнённый режим) используйте.
