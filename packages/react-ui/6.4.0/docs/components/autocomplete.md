...
> Package: `@skbkontur/react-ui` · Version: `6.4.0` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/?path=/docs/react-ui_input-data-autocomplete--docs)
...
В отличие от [комбобокса](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/combobox.md) у поля нет стрелки и список со значениями нельзя открыть вручную. Подробнее об отличиях читайте в [Гайде](https://guides.kontur.ru/components/input-fields/combobox).
...
Для автокомплита может быть задана маска. Автокомплит наследует от [MaskedInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/maskedinput.md) пропсы:
