...
> Package: `@skbkontur/react-ui` · Version: `6.4.0` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/?path=/docs/react-ui_menu-menuseparator--docs)
...
Используется в компонентах [DropdownMenu](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/dropdownmenu.md), [Kebab](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/kebab.md), [TooltipMenu](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/tooltipmenu.md) и [Select](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/select.md).
