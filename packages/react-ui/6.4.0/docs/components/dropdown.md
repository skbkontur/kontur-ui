...
> Package: `@skbkontur/react-ui` · Version: `6.4.0` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/?path=/docs/react-ui_menu-dropdown--docs)
...
- [DropdownMenu](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/dropdownmenu.md) — выбирайте, когда нужен более гибкий сценарий:
  произвольный `caption` (в том числе render-function), кастомные `header`/`footer`, управление `positions`.
- [TooltipMenu](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/tooltipmenu.md) — используйте, если меню должно отображаться в тултипе.
- [Kebab](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/kebab.md) — используйте узкую кнопку для малоиспользуемых ссылок и действий.
- [Select](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/select.md) — используйте для выбора значения из набора вариантов.
- [MenuItem](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/menuitem.md), [MenuSeparator](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/menuseparator.md), [MenuHeader](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/menuheader.md), [MenuFooter](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/menufooter.md) — элементы внутри меню.
...
Доступные стили соответствуют кнопке, подробнее в [Button](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/button.md#%D1%81%D1%82%D0%B8%D0%BB%D1%8C).
...
Если нужно настроить пороги переключения между десктопным и мобильным режимами, используйте настройки из раздела [Адаптивность компонентов](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/?path=/docs/react-ui_information-responsive--docs).
