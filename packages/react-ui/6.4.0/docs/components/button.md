...
> Package: `@skbkontur/react-ui` · Version: `6.4.0` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/?path=/docs/react-ui_button-button--docs)
...
- [Link](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/link.md) — если необходима кнопка, выглядящая как ссылка, можно переопределить корневой элемент на `component=button`.
- [Group](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/group.md) — если необходимы кнопки в составе группы элементов по горизонтали.
...
Общие переменные темы и переменные для кнопки (с префиксом `btn`) смотрите на странице [ThemePlayground](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/?path=/docs/react-ui_information-themeplayground--docs) .
