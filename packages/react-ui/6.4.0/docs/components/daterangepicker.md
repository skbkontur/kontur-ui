...
> Package: `@skbkontur/react-ui` · Version: `6.4.0` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/?path=/docs/react-ui_date-components-daterangepicker--docs)
...
- `<DateRangePicker.Start>` — начало периода с настройками как у [DateInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/dateinput.md).
- `<DateRangePicker.End>` — окончание периода с настройками как у [DateInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/dateinput.md).
...
Вы можете кастомизировать части поля. В примере ниже задан кастомный вид для дня календаря. Ещё примеры кастомизации смотрите на странице компонента [Calendar](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/calendar.md).
