...
> Package: `@skbkontur/react-ui` · Version: `6.4.0` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/?path=/docs/react-ui_overlay-hint--docs)
...
Используйте [Tooltip](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/tooltip.md) в случаях, когда нужна:
