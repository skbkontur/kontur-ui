...
> Package: `@skbkontur/react-ui` · Version: `6.4.0` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/?path=/docs/react-ui_display-data-tabs--docs)
...
- Для состояний — для этого есть [RadioGroup](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/radiogroup.md), [Toggle](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/toggle.md) и [Switcher](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.0/docs/components/switcher.md).
