...
> Package: `@skbkontur/react-ui` · Version: `6.3.4` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/?path=/docs/react-ui_overlay-toast--docs)
...
- [SingleToast](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/docs/components/singletoast.md) — тот же сценарий уведомлений без монтирования своего `Toast` и вызова через `ref`.
