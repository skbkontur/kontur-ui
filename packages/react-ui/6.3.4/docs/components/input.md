...
> Package: `@skbkontur/react-ui` · Version: `6.3.4` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/?path=/docs/react-ui_input-data-input--docs)
...
Для полей с длинными текстовыми комментариями используйте [Textarea](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/docs/components/textarea.md).

Для ввода значений в определенном формате, используйте специальную версию поля:

- [PasswordInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/docs/components/passwordinput.md) — поле для ввода пароля, в котором символы заменяются на точки.
- [CurrencyInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/docs/components/currencyinput.md) — поле для ввода денежных сумм в разной валюте.
- [MaskedInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/docs/components/maskedinput.md) — поле с маской.
- [FxInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/docs/components/fxinput.md) — автополе.

Если же список значений заранее определен и должен отображаться пользователю для выбора, подойдут поля с подсказками:

- [Autocomplete](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/docs/components/autocomplete.md)
- [Combobox](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/docs/components/combobox.md)
- [TokenInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/?path=/docs/react-ui_input-data-tokeninput-tokeninput--docs)
