...
> Package: `@skbkontur/react-ui` · Version: `6.3.4` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/?path=/docs/react-ui_menu-dropdownmenu--docs)
...
- [Dropdown](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/docs/components/dropdown.md) — используйте упрощенную версию, если вам не требуется гибкость настройки `caption`, `header`, `footer`, `positions`.
- [TooltipMenu](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/docs/components/dropdownmenu.md) — используйте, если вам нужно меню в тултипе.
