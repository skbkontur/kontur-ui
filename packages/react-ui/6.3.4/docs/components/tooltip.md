...
> Package: `@skbkontur/react-ui` · Version: `6.3.4` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/?path=/docs/react-ui_overlay-tooltip--docs)
...
Для краткой текстовой подсказки по наведению используйте [Hint](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.3.4/docs/components/hint.md).
