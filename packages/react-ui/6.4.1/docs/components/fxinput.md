...
> Package: `@skbkontur/react-ui` · Version: `6.4.1` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/?path=/docs/react-ui_input-data-fxinput--docs)
...
Примеры для базовых пропсов вы можете посмотреть на странице [Input](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/input.md) и [CurrencyInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/currencyinput.md).

Пропсы для добавления маски в поле наследуются от [MaskedInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/maskedinput.md).
