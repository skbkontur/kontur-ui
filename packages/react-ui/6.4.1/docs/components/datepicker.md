...
> Package: `@skbkontur/react-ui` · Version: `6.4.1` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/?path=/docs/react-ui_date-components-datepicker--docs)
...
- [DateInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/dateinput.md) — компонент поля с маской для выбора даты с клавиатуры.
- [Calendar](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/calendar.md) — компонент календаря для выбора даты с помощью мыши.
...
В проп `isHoliday` можно передать функцию, которая будет получать день строкой формата `dd.mm.yyyy` и флаг `isWeekend` из [компонента дня](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/?path=/docs/react-ui_date-components-calendarday--docs).
...
Вы можете кастомизировать части поля с датой. В примере ниже задан кастомный вид для дня календаря. Ещё примеры кастомизации смотрите в компоненте [Calendar](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/calendar.md).
...
Для сравнения и валидации дат в строках формата `DD.MM.YYYY` доступен набор утилит [Date Utilities](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/?path=/docs/react-ui_date-components-date-utilities--docs).
...
Вы можете передавать свои медиазапросы, больше о настройке адаптивности читайте в статье [Адаптивность компонентов](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/?path=/docs/react-ui_information-responsive--docs).
