...
> Package: `@skbkontur/react-ui` · Version: `6.4.1` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/?path=/docs/react-ui_display-data-globalloader--docs)
...
- для индикации загрузки отдельных элементов интерфейса, в этом случае используйте ['Loader'](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/loader.md);
