...
> Package: `@skbkontur/react-ui` · Version: `6.4.1` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/?path=/docs/react-ui_input-data-input--docs)
...
Для полей с длинными текстовыми комментариями используйте [Textarea](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/textarea.md).

Для ввода значений в определенном формате, используйте специальную версию поля:

- [PasswordInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/passwordinput.md) — поле для ввода пароля, в котором символы заменяются на точки.
- [CurrencyInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/currencyinput.md) — поле для ввода денежных сумм в разной валюте.
- [MaskedInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/maskedinput.md) — поле с маской.
- [FxInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/fxinput.md) — автополе.

Если же список значений заранее определен и должен отображаться пользователю для выбора, подойдут поля с подсказками:

- [Autocomplete](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/autocomplete.md)
- [Combobox](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/combobox.md)
- [TokenInput](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/?path=/docs/react-ui_input-data-tokeninput-tokeninput--docs)
...
С помощью пакета [React UI Validations](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/?path=/docs/react-ui-validations_api-reference) можно добавить валидацию для компонента.
