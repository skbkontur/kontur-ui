...
> Package: `@skbkontur/react-ui` · Version: `6.4.1` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/?path=/docs/react-ui_menu-kebab--docs)
...
- [Dropdown](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/dropdown.md) — если необходима кастомизируемая кнопка вместо простой иконки кебаба.
- [DropdownMenu](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/dropdownmenu.md) — если необходим произвольный элемент `caption` вместо кнопки.
