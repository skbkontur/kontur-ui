...
> Package: `@skbkontur/react-ui` · Version: `6.4.1` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/?path=/docs/react-ui_input-data-maskedinput--docs)
...
Примеры для базовых пропсов вы можете посмотреть на странице [Input](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/input.md).
...
Для компонента действуют все те же рекомендации по доступности, что и для компонента [Input](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/input.md).
