...
> Package: `@skbkontur/react-ui` · Version: `6.4.1` · [Storybook](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/?path=/docs/react-ui_input-data-fileuploader--docs)
...
Подробнее на странице [FileUploaderFile](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/?path=/docs/input-data-fileuploader-fileuploaderfile--docs).
...
- **Подсказки:** обрезанное имя доступно через [Hint](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/hint.md); текст проверки файла может выводиться в [Tooltip](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/tooltip.md) при `withValidationTooltip` или в плиточном виде.
...
Строка файла (FileUploaderFile) использует [Tooltip](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/tooltip.md) и [Hint](https://tech.skbkontur.ru/kontur-ui/packages/react-ui/6.4.1/docs/components/hint.md). Удаление — фокусируемая кнопка с активацией по `Enter`.
