...
`,n.jsx(o.pre,{children:n.jsx(o.code,{className:"language-typescript",children:`import { CdnLogo, CdnLogoProvider } from "@skbkontur/ui-cdn-components";

// Название логотипа без размера: базовый вариант, -dark, -vertical, -vertical-dark.
// Полный список доступных значений — в типе LogosType.
