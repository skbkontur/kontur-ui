import{_ as bn,a as y}from"./toPropertyKey-D-GQYuxn.js";import{c as i,_ as r,l as Qr,n as I,m as en,j as nn,d as Jr,T as W,b as M,o as sn,r as Cn,a as On,C as zn,e as Dn,q as Tn,s as Xr,t as Kr,k as Ln,p as ni,u as Or,w as ei,v as ti,x as xn,y as Fn}from"./Gapped-uHYrem14.js";import{R as d,r as k}from"./index-Bk3ZmH4I.js";import{a as ri,Z as ii,f as tn,B as rn}from"./BaseIcon-OD9LLRCk.js";import{j as _}from"./jsx-runtime-wTqLqomF.js";var Hn,$n,zr=function(){return i(Hn||(Hn=r([`
    outline: none;
    border: none;
...
`]))),wi=function(n){var l=parseFloat(n.linkTextUnderlineOpacity)-1;return i(be||(be=r([`
  ...
  `])),n,Ar(o,t),l)},Mn=function(n,l){return i(Fe||(Fe=r([`
    padding: `,`;
    line-height: normal;
  `])),Ar(l,n))},He,$e,Ue,Ge,Ye,Ze,Ve,qe,Qe,Je,Xe,Ke,nt,et,tt,rt,it,ot,at,lt,ct,st,ut,dt,gt,mt,bt,ht,ft,pt,vt,It,xt,wt,Mt,yt,St,Lt,jt,kt,Ct,Ot,zt,Dt,Tt,At,_t,Bt,Et,Nt,Wt,Pt,Rt,Ft,Ht,$t,Ut,Gt,Yt,Zt,Vt,qt,Qt,Jt,Xt,Kt,nr,er,tr,rr,ir,or,ar,lr,cr,sr,ur,dr,gr,E=ni("button")({root:"root",arrow:"arrow",caption:"caption",text:"text",innerShadow:"inner-shadow",disabled:"disabled"}),g=en({root:function(n){return i(He||(He=r([`
      `,`;
      `,`;
    ...
    `])),q(n.btnBacklessActiveBg,"",n.btnBacklessActiveBorderColor,n.btnBorderWidth))}}),mr,br,hr,fr,pr,vr,Ir,xr,wr,Mr,yr,Sr,Lr,A=en({icon:function(){var n="'"+ii+"'";return i(mr||(mr=r([`
      display: inline-block;
